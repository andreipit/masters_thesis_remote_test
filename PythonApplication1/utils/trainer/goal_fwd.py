...
class TrainerGoalFwd(object):

    def goal_forward(self, a: ArgsModel, m: TrainerModel, color_heightmap, depth_heightmap, goal_mask_heightmap, is_volatile=False, specific_rotation=-1):
        ...
        output_prob, state_feat= m.model.forward(input_color_data, input_depth_data, input_goal_mask_data, is_volatile, specific_rotation)
